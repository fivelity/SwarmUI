...
class ImageEditor {
    ...
    createCanvas() {
        ...
        document.addEventListener('touchstart', (e) => this.onGlobalMouseDown(e), { passive: false });
        canvas.addEventListener('touchstart', (e) => this.onMouseDown(e), { passive: false });
        document.addEventListener('touchend', (e) => this.onGlobalMouseUp(e), { passive: true });
        canvas.addEventListener('touchend', (e) => this.onMouseUp(e), { passive: true });
        document.addEventListener('touchmove', (e) => this.onGlobalMouseMove(e), { passive: false });
